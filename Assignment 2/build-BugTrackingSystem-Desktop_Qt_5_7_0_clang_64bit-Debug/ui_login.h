...
public:
    ...
    void setupUi(QMainWindow *Login)
    {
        ...
        label->setGeometry(QRect(20, 170, 311, 41));
        groupBox = new QGroupBox(centralWidget);
        groupBox->setObjectName(QStringLiteral("groupBox"));
        groupBox->setGeometry(QRect(90, 20, 241, 131));
        pushButton = new QPushButton(groupBox);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(60, 100, 113, 32));
        layoutWidget = new QWidget(groupBox);
        layoutWidget->setObjectName(QStringLiteral("layoutWidget"));
        layoutWidget->setGeometry(QRect(20, 40, 197, 23));
        ...
        layoutWidget_2->setGeometry(QRect(20, 70, 194, 23));
